package algs.meta_heuristics.structures.concrete.infinite.neighbourhood

import algs.meta_heuristics.structures.specification.inifinite.neighbourhood.{RandDoubleNeighbourhoodSearch, InfiniteNeighbourhoodTraitSeq, RandIntNeighbourhoodSearch}

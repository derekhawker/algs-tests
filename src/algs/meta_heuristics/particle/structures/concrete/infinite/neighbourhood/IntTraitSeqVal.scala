...
import algs.meta_heuristics.particle.structures.specification.inifinite.neighbourhood.{RandDoubleNeighbourhoodSearch, InfiniteNeighbourhoodTraitSeq, RandIntNeighbourhoodSearch}

...
import com.derek.algs.structures.specification.inifinite.neighbourhood.{RandDoubleNeighbourhoodSearch, InfiniteNeighbourhoodTraitSeq, RandIntNeighbourhoodSearch}
